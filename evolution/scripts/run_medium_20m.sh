...
NEMOTRON_MAX_CONCURRENT_REQUESTS="${KERNELSWARM_NEMOTRON_MAX_CONCURRENT_REQUESTS:-128}"
...
PROPOSAL_WORKERS="${KERNELSWARM_PROPOSAL_WORKERS:-40}"
...
echo "  agents generators=$GENERATORS" >&2
