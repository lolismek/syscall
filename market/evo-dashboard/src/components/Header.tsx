...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-surface-200 bg-[#09090b]/80 backdrop-blur-xl">
      <div className="mx-auto max-w-[1600px] px-4 py-3 flex items-center gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <div className="h-6 w-6 bg-gradient-to-br from-accent to-info flex items-center justify-center text-[10px] font-bold text-white">
            KS
          </div>
