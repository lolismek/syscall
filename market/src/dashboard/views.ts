...
export function getEvolutionDetailViewHtml(): string {
  return `
  <div class="view" id="viewEvolution">
    <div class="hero" style="margin-bottom:20px">
      <div class="breadcrumb">
        <button class="breadcrumb-link" onclick="showProjectList()">&larr; Projects</button>
        <span class="breadcrumb-sep">/</span>
        <span class="breadcrumb-current" id="evoBreadcrumbName">...</span>
      </div>
    </div>

    <div class="detail-header">
      <div class="detail-header-left">
        <div class="detail-header-name" id="evoRunName">...</div>
        <div class="detail-header-desc" id="evoRunDesc"></div>
      </div>
    ...
    <div class="panel">
      ...
      <div class="evo-kpi-grid" id="evoKpiGrid"></div>
    </div>

    <div class="panel">
      <div class="panel-title">Optimization Progress</div>
      <div class="evo-charts-row">
        <div class="evo-chart-wrap">
          <div class="evo-chart-label">Best Fitness over iterations</div>
          <canvas id="evoChartFitness" width="580" height="260"></canvas>
        </div>
        <div class="evo-chart-wrap">
          <div class="evo-chart-label">Best Median Latency over iterations (&micro;s)</div>
          <canvas id="evoChartLatency" width="580" height="260"></canvas>
        </div>
      </div>
    </div>
    ...
    <div class="panel">
      ...
      <div class="evo-chart-wrap" style="max-width:600px">
        <canvas id="evoChartTokens" width="580" height="200"></canvas>
      </div>
    </div>

    <div class="panel">
      <div class="panel-title">Candidate States</div>
      <div class="evo-leaderboard" id="evoStateCounts"></div>
    </div>

    <div class="panel">
      <div class="panel-title">Island Evolution State</div>
      <div class="evo-islands-grid" id="evoIslands"></div>
    </div>

    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
      <div class="panel">
        <div class="panel-title">Quick Leaderboard</div>
        <div class="evo-leaderboard" id="evoLeaderboardQuick"></div>
      </div>
      <div class="panel">
        <div class="panel-title">Full Leaderboard</div>
        <div class="evo-leaderboard" id="evoLeaderboardFull"></div>
      </div>
    </div>
  </div>`;
}
